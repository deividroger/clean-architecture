...
const customer1 = CustomerFactory.createWithAddress("John", new Address("street", 10, "zip", "city"));

const customer2 = CustomerFactory.createWithAddress("John 2", new Address("street 1", 11, "zip2", "city2"));
